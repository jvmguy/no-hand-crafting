data:extend({
  {
    ...
    icon = "__jvmguy-no-hand-crafting__/graphics/icons/burner-assembling-machine.png",
    ...
    animation = {
      filename = "__jvmguy-no-hand-crafting__/graphics/entity/burner-assembling-machine/burner-assembling-machine.png",
      priority="high",
      width = 99,
      height = 102,
      frame_count = 32,
